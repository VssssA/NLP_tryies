...
if __name__ == '__main__':
    ...
    #
    # for i in range(len(full_text[0:100])):
    #     print(f"{full_text[i]}, sim:{predict_similarity(full_text[i])}")

    first_text = ['как хорошо живется у нас в странне', 'я люблю свою страну и желаю ей всего самого хорошего']
